...
-- 사번, 이름, 급여 순으로 출력
select a.emp_no, concat(a.first_name, ' ', a.last_name), s.salary
 from employees a join salaries s on a.emp_no = s.emp_no
  where s.to_date = '9999-01-01';

-- 실습문제3
-- 현재, 직책별 평균연봉, 직원수를 구하되 직책별 직원수가 100명 이상인 직책만 출력하세요.
-- 직책, 평균연봉 직원수 순으로 출력 salaries, titles
 select title, avg(a.salary), count(*)
...
-- 부서 이름, 평균 급여 순으로 출력하세요. departments dept_emp titles salaries
